...
setwd("/Users/velazqal/Documents/00_Bioinformatic pipelines/week5")
...
plot_QC_features(mouse_brain, 'Plots/5k_mouse_brain_GEX_QC_Pre.pdf')

saveRDS(mouse_brain, 'Data/mouse_brain_multiome_Pre_QC.rds')
...
saveRDS(mouse_brain, 'Data/mouse_brain_multiome_Post_QC.rds')
# mouse_brain <- readRDS('Data/mouse_brain_multiome_Post_QC.rds')
plot_QC_features(mouse_brain, 'Plots/5k_mouse_brain_GEX_QC_Post.pdf')
...
saveRDS(mouse_brain, '/ibex/user/serrang/Projects_data/MultiomeCourse/Data/mouse_brain_multiome.rds')
...
saveRDS(mouse_brain, '/ibex/user/serrang/Projects_data/MultiomeCourse/Data/mouse_brain_multiome_Integrated.rds')

pdf('/ibex/user/serrang/Projects_data/MultiomeCourse/Plots/Umap_integrated.pdf')
...
pdf('/ibex/user/serrang/Projects_data/MultiomeCourse/Plots/Umap_integrated_weights.pdf')
...
saveRDS(da_peaks, '/ibex/user/serrang/Projects_data/MultiomeCourse/Data/DA_peaks.rds')

da_peaks <- da_peaks[order(da_peaks$avg_log2FC, decreasing = TRUE), ]

pdf('/ibex/user/serrang/Projects_data/MultiomeCourse/Plots/Peaks_DA.pdf', width=12, height=20)
cowplot::plot_grid(
  VlnPlot(
    object = mouse_brain,
    assay = 'ATAC',
...
pdf('/ibex/user/serrang/Projects_data/MultiomeCourse/Plots/Coverage_selected.pdf', height=12)
CoveragePlot(
  object = mouse_brain,
  region = c('Olig1', 
             'Gfap'),
...
pdf('/ibex/user/serrang/Projects_data/MultiomeCourse/Plots/Motif_enrichment.pdf')
MotifPlot(
  object = mouse_brain,
...
pdf('/ibex/user/serrang/Projects_data/MultiomeCourse/Plots/RNA_comparison.pdf', height=12)
cowplot::plot_grid(
  RNA_plot,
  RNA_Activity_plot,
nrow=2)
